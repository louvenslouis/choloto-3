...
Les seules règles Firestore de cette fonctionnalité ont été déployées le 6 septembre 2026 à 02:42 UTC, en préservant exactement les autres règles de production. Voir [le rapport de déploiement](payment-proof-rules-deployment.md). L’exemption d’index Base64 et les nouvelles versions de l’application et du dashboard n’ont pas été publiées dans cette intervention. La fonctionnalité n’ajoute aucune Cloud Function et n’utilise pas Firebase Storage.
