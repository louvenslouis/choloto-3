      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Tirages')
              : TiragesWidget(),
        ),
        FFRoute(
          name: TchalaWidget.routeName,
          path: TchalaWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Tchala')
              : TchalaWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: StripeWidget.routeName,
          path: StripeWidget.routePath,
        ...
        FFRoute(
          name: ConditionsWidget.routeName,
          path: ConditionsWidget.routePath,
          builder: (context, params) => ConditionsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CustomerserviceWidget.routeName,
          path: CustomerserviceWidget.routePath,
          builder: (context, params) => CustomerserviceWidget(),
        ),
        FFRoute(
            name: VipWidget.routeName,
            path: VipWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'VIP')
                : NavBarPage(
                    initialPage: 'VIP',
                    page: VipWidget(),
                  )),
        ...
        FFRoute(
          name: AccomplissementsWidget.routeName,
          path: AccomplissementsWidget.routePath,
          builder: (context, params) => AccomplissementsWidget(),
        )
