...
import 'customerservice_model.dart';
export 'customerservice_model.dart';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CUSTOMERSERVICE_arrow_back_rounded_ICN_O');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'xx4qds3f' /* Contact Customer Service */,
                  ),
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'ujyy941k' /* We're here to help! Send us a ... */,
                  ),
                  textAlign: TextAlign.center,
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            'doxx134q' /* L'email qu'on pourra vous repo... */,
                          ),
                          labelStyle:
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'fnr6ppen' /* Enter your email address */,
                          ),
                          hintStyle:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'j27u9muy' /* Describe your issue or questio... */,
                          ),
                          hintStyle:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'lvctbl78' /* We typically respond within 24... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('CUSTOMERSERVICE_SEND_MESSAGE_BTN_ON_TAP');
                    logFirebaseEvent('Button_send_email');
                    await launchUrl(Uri(
                        scheme: 'mailto',
                        path: 'contact@choloto.com',
                        query: {
                          'subject': 'ISSUE_APP',
                          'body':
                              'officialMail: ${currentUserEmail}Email: ${_model.mailTextController.text} Message: ${_model.textController2.text}',
                        }
                            .entries
