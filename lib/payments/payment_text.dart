...
String paymentText(BuildContext context, String key) {
  ...
  return FFLocalizations.of(context)
      .getVariableText(frText: values[0], enText: values[1], crText: values[2]);
}
...
String paymentMethodLabel(BuildContext context, String method) =>
    switch (method) {
      'cash' => FFLocalizations.of(context).getVariableText(
          frText: 'Espèces', enText: 'Cash', crText: 'Lajan kach'),
      'virement' => FFLocalizations.of(context).getVariableText(
